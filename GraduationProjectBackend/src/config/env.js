...
mailBrand: process.env.MAIL_BRAND ?? "GPMS",
  ...
  googleCalendarClientId: str(process.env.GOOGLE_CALENDAR_CLIENT_ID) ?? str(process.env.GOOGLE_CLIENT_ID),
  googleCalendarClientSecret: str(process.env.GOOGLE_CALENDAR_CLIENT_SECRET) ?? str(process.env.GOOGLE_CLIENT_SECRET),
  googleCalendarRedirectUri: str(process.env.GOOGLE_CALENDAR_REDIRECT_URI),

  microsoftClientId: str(process.env.MICROSOFT_CLIENT_ID),
  microsoftClientSecret: str(process.env.MICROSOFT_CLIENT_SECRET),
  microsoftTenantId: str(process.env.MICROSOFT_TENANT_ID) ?? "common",
  microsoftRedirectUri: str(process.env.MICROSOFT_REDIRECT_URI),
  calendarTokenEncryptionSecret: str(process.env.CALENDAR_TOKEN_ENCRYPTION_SECRET) ?? str(process.env.JWT_SECRET),
