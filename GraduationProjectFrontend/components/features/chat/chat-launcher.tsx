...
export function ChatLauncher() {
  ...
  const onGamificationDashboard = pathname === "/dashboard/gamification"
  ...
  return (
    <>
      <div className={cn("pointer-events-none fixed right-4 z-[70] sm:bottom-6 sm:right-6", onGamificationDashboard ? "bottom-20" : "bottom-5")}>
        <motion.div
        ...
        >
          <Button
            ...
            className={cn(
              "relative shadow-[0_24px_60px_-24px_rgba(37,99,235,0.65)]",
              onGamificationDashboard ? "h-12 w-12 rounded-2xl sm:h-14 sm:w-14 sm:rounded-[22px]" : "h-14 w-14 rounded-[22px]",
            )}
            size="icon"
          >
        ...
        {open ? (
          <>
            ...
            <motion.div
              ...
              className={cn(
                "fixed inset-x-3 top-20 z-[68] sm:inset-auto sm:bottom-24 sm:right-6 sm:top-auto sm:h-[min(82vh,720px)] sm:w-[min(92vw,480px)] flex flex-col overflow-hidden rounded-[32px] shadow-[0_32px_80px_-28px_rgba(0,0,0,0.75)] dark:border-zinc-800/60 border border-border/70 bg-card dark:bg-zinc-950",
                onGamificationDashboard ? "bottom-[7.25rem]" : "bottom-[5.5rem]",
              )}
